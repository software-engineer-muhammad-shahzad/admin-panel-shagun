    ...
    return (
        ...
        >
            <div className=" p-2 max-w-[250px] md:max-w-[300px]">
                ...
                <p className="text-white mt-4 font-light">Are you sure you want to delete this couple?</p>
                {/* button No Yes */}
                ...
                >
                    <div className="text-center max-w-[250px] md:max-w-[300px]">
                        ...
                        <p className="text-white/80 text-sm mb-6">
                            Your couple has been successfully deleted.
                        </p>
